...
public abstract class Cache {
    ...
    public static boolean safeAdd(String key, Object value, String expiration) {
        checkSerializable(value);
        return cacheImpl.safeAdd(key, value, TimeUtil.parseDuration(expiration));
    }
    ...
    public static boolean safeSet(String key, Object value, String expiration) {
        checkSerializable(value);
        return cacheImpl.safeSet(key, value, TimeUtil.parseDuration(expiration));
    }
    ...
    public static boolean safeReplace(String key, Object value, String expiration) {
        checkSerializable(value);
        return cacheImpl.safeReplace(key, value, TimeUtil.parseDuration(expiration));
    }
    ...
    /**
     * Retrieve an cacheItem object.
     * @param key The element key
     * @return The cacheItem value or null
     */
